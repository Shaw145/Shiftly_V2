...
export default function Hero() {
  return (
    <section className="relative w-full flex flex-col md:flex-row items-center justify-between px-17 py-15 md:pt-35 lg:pt-30 bg-white overflow-hidden">
      ...
      <div className="md:w-1/3 text-left space-y-6 z-10 md:pl-20">
        ...
        >
          Shiftly provides seamless transportation solutions for households and businesses, ensuring fast, safe, and reliable delivery across India.
        </motion.p>
        ...
        <div className="flex xxs:space-x-8 lg:space-x-20 mt-12">
          <div className="flex items-center space-x-2">
            ...
            <div>
              ...
              <p className="text-gray-600">Track your goods in real-time with precise updates.</p>
            </div>
          </div>
          ...
          <div className="flex items-center space-x-2">
            ...
            <div>
              ...
              <p className="text-gray-600">Efficient logistics to get your items delivered on time.</p>
            </div>
          </div>
      ...
      <div className="relative md:w-1/2 flex items-center justify-center mt-10 md:mt-0 z-10">
        ...
        <motion.img
          src="src/assets/hero-truck2.png"
          alt="Hero Truck"
